...
class Logger {
	...
	success(input) {
		const time = new Date();
		input = `[WS2] [${time.getHours()}:${time.getMinutes()}:${time.getSeconds()}] [SUCCESS]: ${input}`;
	...
	error(input) {
		const time = new Date();
		input = `[WS2] [${time.getHours()}:${time.getMinutes()}:${time.getSeconds()}] [ERROR]: ${input}`;
	...
	warn(input) {
		const time = new Date();
		input = `[WS2] [${time.getHours()}:${time.getMinutes()}:${time.getSeconds()}] [WARN]: ${input}`;
	...
	info(input) {
		const time = new Date();
		input = `[WS2] [${time.getHours()}:${time.getMinutes()}:${time.getSeconds()}] [INFO]: ${input}`;
